...
### apologetics/
Arguments for Christianity, responses to skeptics, debate tactics, burden of proof, presuppositional content

### epistemology/
Knowledge theory, logic, rationality, naturalism critique, Logos arguments, TAG variations

### science-and-faith/
Creation, evolution critique, cosmology, fine-tuning, abiogenesis, flood geology, radiometric dating

### theology/
Doctrine, Trinity, Christology, soteriology, covenant theology, systematic theology

### biblical-studies/
Exegesis, hermeneutics, biblical interpretation, Genesis 6, Nephilim, Scripture reliability

### theodicy/
Problem of evil, suffering, hell, divine justice, divine hiddenness

### ai-and-technology/
AGI impossibility, AI limitations, AIDK framework, consciousness, Imago Dei vs machines

### cultural-commentary/
Current events, cultural critique, church issues, public figures (Kirk Cameron, Charlie Kirk, etc.)

### ethics/
Moral philosophy, slavery passages, sexual ethics, Euthyphro, moral grounding

---

## Sprint Phases

### Sprint 1: High-Priority Frameworks (20 articles)
Core arguments and frameworks that anchor the wiki.

| # | Status | Title | Category |
|---|--------|-------|----------|
| 1 | ✅ | The Logos-Structured Reality | epistemology |
| 2 | ✅ | oddXian: Challenge the Consensus | apologetics |
| 3 | ✅ | Why Believe God Exists? | apologetics |
| 4 | ✅ | Reconciling Suffering with a Good God | theodicy |
| 5 | ✅ | Freedom Fulfilled: How Christ Reveals True Human Agency | theology |
| 6 | ✅ | The Incoherence of Atheistic Naturalism | epistemology |
| 7 | ✅ | The Logos Syllogism: A Novel Logical Framing | epistemology |
| 8 | ✅ | Introducing the Duality Argument | apologetics |
| 9 | ✅ | The Rational Structure of Reality | epistemology |
| 10 | ✅ | Logic, Contingency, and the Necessity of Rational Ground | epistemology |
| 11 | ✅ | Literal Programmatic Intervention (LPI) | science-and-faith |
| 12 | ✅ | The Communion Argument | apologetics |
| 13 | ✅ | A Systematic Declaration of Faith and Reason | theology |
| 14 | ✅ | God of the System, Not the Gaps | apologetics |
| 15 | ✅ | Mind as Foundation: A Cumulative Case | apologetics |
| 16 | ✅ | Why AGI Is Metaphysically Impossible | ai-and-technology |
| 17 | ✅ | The Image of God and the Impossibility of AGI | ai-and-technology |
| 18 | ✅ | Methodological Designism vs. Methodological Naturalism | science-and-faith |
| 19 | ✅ | No Circles Here: Defense of Presuppositional Apologetics | apologetics |
| 20 | ✅ | Presuppositional Classicism: A Both/And Apologetic | apologetics |

### Sprint 2: Naturalism Critique (20 articles)
Exposing internal problems with atheistic naturalism.

| # | Status | Title | Category |
|---|--------|-------|----------|
| 21 | ✅ | The Naturalist Trilemma | epistemology |
| 22 | ✅ | Null Hypothesis: Four Explanatory Voids | epistemology |
| 23 | ✅ | The Illusion of Explanation | epistemology |
...
1. **Locate HTML** in `substack_export/posts/`
2. **Convert to Markdown** (strip HTML, preserve formatting)
3. **Add frontmatter:**
   ```yaml
   ---
   title: "Article Title"
   ...
   ---
   ```
4. **File to category folder** with kebab-case filename
...
- Unpublished: `Welcome to oddXian` (draft), `Literal Programmatic Intervention` (draft version)
- Duplicate: `Why I am an Unapologetic Biblical Christian` (two versions)
- Podcast: `Addressing a common skeptic tactic` (audio content)

---

## Session Log

| Date | Sprint | Articles | Notes |
|------|--------|----------|-------|
| 2026-01-28 | 1 (partial) | 5 | Initial conversion |
| 2026-01-29 | — | — | Sprint plan created |
| 2026-01-29 | — | — | Category corrections: moved slavery→ethics, renamed epistemology file, updated plan |
