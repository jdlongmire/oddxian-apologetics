...
The remainder of this paper develops the hydrotectonic model in detail, addresses specific objections, and identifies testable predictions. The core propositions advanced are:
...
2. **Mechanical plausibility:** Near-lithostatic pore pressures reduce effective stress to <1% of lithostatic, collapsing friction to negligible levels and enabling hydroplaning on thin water films along shallow detachment horizons.

3. **Water budget closure:** Earth's total water inventory remains constant. Pre-flood mobile water, distributed in crustal fracture networks, undercompacted sediments, and surface basins, drained into ocean basins or was subducted into the mantle transition zone where it became sequestered in hydrous minerals (ringwoodite, wadsleyite).

4. **Structured deposition:** Fossil order emerges from ecological zonation (reflecting pre-flood habitat distribution by elevation), hydraulic sorting (by size, density, and mobility), and basin-scale depositional geometry—not temporal succession.

5. **Transition to modern tectonics:** Post-collapse drainage exhausted the hydraulic network, blocks re-coupled to the mantle, and plate velocities dropped to modern geothermal rates. What we observe today as mantle-driven plate tectonics is the equilibrium state following hydraulic collapse.

6. **Testable predictions:** The model generates specific predictions including large-scale detachment horizons, chaotic megabreccias at basin boundaries, pressure and thermal anomalies, geochemical signatures of massive fluid flow, and structural evidence distinguishing hydraulic from geothermal processes.
...
**Crustal storage capacity:** Modern crustal porosity and permeability values cannot be retroactively applied to the pre-flood lithosphere. Present-day statistics (1-5% in upper continental crust, <1% in lower crust; Turcotte and Schubert, 2002) reflect billions of years of compaction, metamorphism, and tectonic stiffening. The hydrotectonic regime assumes a distinct, fluid-rich crustal architecture: undercompacted sediments, interconnected fracture networks, fault-bounded aquifers, overpressured basins approaching lithostatic pore pressure, and serpentinized upper mantle zones holding 10-15 wt% water (Ulmer and Trommsdorff, 1995; Hacker et al., 2003). The dominant share of the mechanically active water budget existed as liquid in surface and crustal reservoirs prior to collapse.

The model does not require zero bound water before the flood. Some fraction was likely sequestered in hydrated minerals (serpentinized mantle, amphiboles, micas, early transition-zone phases), but the mechanically active portion was dominantly liquid and distributed through the crust and surface basins. This mobile fraction provided the hydraulic medium for rapid block motion, while bound water at depth was passive during collapse, becoming the primary sink for mobile water during post-flood subduction.
...
![Pre-flood hydrotectonic crustal architecture](messy_layers.png)
...
4. **Distributed strain over extensive regions**: Because the water network is extensive and interconnected, deformation is not concentrated in narrow shear zones but spread across basin-scale volumes. This distributes heat generation over volumes large enough that local temperature increases remain modest.
...
**Quantitative force balance:** Consider a continental block 800 km × 1000 km × 35 km thick (mass M ≈ 8 × 10¹⁹ kg). Even a gentle slope of 0.1° produces a gravitational driving force F_grav = Mg sin(0.1°) ≈ 1.3 × 10¹⁸ N. Horizontal pressure gradients of 10 Pa/m over basin-scale distances (100 km) contribute additional lateral forces F_pressure ≈ 8 × 10¹⁷ N. Total driving force is thus ~2 × 10¹⁸ N. Under friction collapse (effective stress reduced to 1% of lithostatic, friction coefficient μ = 0.01), frictional resistance at a mid-crustal detachment (depth 15 km) is F_friction = μσ'_n A ≈ 3 × 10¹⁶ N, where σ'_n = 4 MPa is the effective normal stress and A is the block's basal area. The net driving force (~2 × 10¹⁸ N) exceeds friction by a factor of ~70, confirming that the system operates in a near-frictionless regime. With net force F_net ≈ 2 × 10¹⁸ N, initial acceleration is a = F_net/M ≈ 0.03 m/s². Over timescales of hours, this produces velocities of tens of meters per hour. Continued acceleration is limited by viscous drag in the water film, interaction with adjacent blocks, and temporal variation in driving forces as pressure gradients evolve. The stated velocities of tens to hundreds of meters per hour are thus consistent with realistic force magnitudes under hydraulic collapse conditions.
...
![Conceptual pre-flood continental configuration](Pangea.png)
...
Mobility and behavioral sorting also operate. Mobile organisms (swimming or flying) can escape rising water to higher ground, being buried later or in different settings than sessile organisms, producing apparent ecological progression even when all existed simultaneously. Taphonomic patterns (articulation, orientation, preservation quality) reflect transport energy and duration: rapid burial in low-energy settings favors articulation and good preservation, while long-distance transport produces disarticulation and abrasion. These processes create a spectrum of preservation states correlating with depositional environment, providing apparent order within catastrophic deposition.
...
Section 4.3 addresses this in detail. Hydraulic collapse produces structure through ecological zonation (spatial habitat distribution preserved by rapid burial), hydraulic sorting (by size, density, shape), mobility sorting, and basin-scale depositional processes. The result is ordered deposition controlled by physical sorting—not random mixing. Anomalies and mixed assemblages occur alongside ordered sequences, exactly as expected in a complex, multi-basin collapse scenario.
...
Radiometric dating systems assume closed-system behavior: parent and daughter isotopes remain in the sample without addition or loss except through radioactive decay. In catastrophic environments with rapid deformation, high fluid fluxes, elevated temperatures, and pervasive fracturing, this assumption is suspect. The model does not reject radiometric decay physics; it asserts that large-scale fluid-rock disequilibrium during collapse disrupts closure conditions, preventing isotopic systems from recording true crystallization ages in the conventional sense. Fluids migrating through fractures can leach or introduce isotopes, resetting or partially resetting apparent ages. Rapid burial and heating can drive diffusion and isotopic re-equilibration. Mixing of materials from different sources during collapse can produce apparent ages that reflect mixing rather than true crystallization or closure.

Documented cases of isotopic disturbance under high fluid flux and deformation provide context for evaluating flood geochemistry. In the Alpine nappes, anomalous argon retention and Rb-Sr disturbance have been attributed to fluid-mediated recrystallization during thrust emplacement, producing complex age patterns that do not correspond to simple crystallization histories. Himalayan leucogranites show U-Pb zircon disturbance where hydrothermal fluids penetrated along shear zones, with some domains recording partial resetting and others preserving inherited ages. The Scandinavian Caledonides exhibit complex isotopic patterns across multiple systems (Rb-Sr, Sm-Nd, U-Pb) interpreted as metamorphic overprinting with fluid involvement, demonstrating that crustal-scale deformation with fluid migration can disturb isotopic systematics over regional scales. These examples illustrate that high-flux hydrothermal environments can reset or partially reset isotopic systems, though the specific patterns produced (concordance versus discordance, complete versus partial reset, systematic offsets versus scatter) depend on temperature, fluid composition, mineral chemistry, and the duration and spatial extent of fluid interaction—all factors that remain poorly constrained for the flood event.
...
These differentiators would distinguish catastrophic root formation from slow uniformitarian evolution and provide testable constraints on the post-collapse timeline.
