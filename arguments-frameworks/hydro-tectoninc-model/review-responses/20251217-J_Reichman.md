...
>
> Even compartmentalized, intermittent, patchy, cascading systems still have to obey the same pressure-diffusion, Darcy-flow, and thermodynamic limits that govern any porous-medium transport. Heterogeneity doesn't suspend those rules - it just moves the problem around. If anything, introducing fracture networks and episodic flow makes the constraints harder to satisfy, because now you have to explain how each local pocket maintains pore pressure without draining into the next lower-pressure zone.
>
> Every time I point to a physical requirement - pressure diffusion, energy dissipation, effective-stress limits, thermal constraints, scale dependence - your answer is that the system is "complex," "heterogeneous," or "time-dependent." None of that is a mechanism. None of it is a calculation. None of it shows that the required conditions can actually be met.
>
> Can near-lithostatic pore pressures be maintained, even intermittently, without the system self-draining, flashing, cavitating, or depressurizing faster than slip can proceed? That's not a philosophical question. It's a quantitative one. Supply the equations, the diffusion timescales, the stability analysis, and the energy budget - or acknowledge that the mechanism remains speculative.
>
> Every real analog we have - fault zones, décollements, overpressured basins, subduction wedges - fails to maintain the pressure regime your mechanism requires even over tens of kilometers, let alone thousands. If you want to invoke a process that operated at continental scale for months, you need to explain why it would succeed where every observed system fails. "The Flood was different" is not an explanation; it's an appeal to miracle dressed up in technical language.
...
![Figure 1: Drainage vs Supply Comparison](../figures/diffusion_vs_supply.png)
...
![Figure 2: Pressure Evolution with Constant Permeability](../figures/pressure_stability.png)

![Figure 3: Pressure Evolution with Slip-Induced Permeability Increase](../figures/pressure_slip_induced_k.png)
...
![Figure 4: Episodic Motion - Pressure Cycling and Displacement](../figures/episodic_motion.png)
