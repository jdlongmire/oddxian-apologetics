---
title: "Appendix C: Earth-System Context for Hydraulic Collapse"
subtitle: "Supplementary Material for 'Rapid Continental Reorganization Through Hydraulic Collapse'"
author: "James (JD) Longmire"
affiliation: "Northrop Grumman Fellow (unaffiliated research)"
orcid: "0009-0009-1383-7698"
date: "2025-11-22"
version: "1.0"
doi: "10.5281/zenodo.17663309"
---

# **Appendix C: Earth-System Context for Hydraulic Collapse**

## **Supplementary Material**

This appendix provides supplementary analysis for the paper "Rapid Continental Reorganization Through Hydraulic Collapse: A Solution to the Heat Problem in Catastrophic Plate Tectonics" (Longmire, 2025). It outlines a broader geophysical environment in which hydrotectonic collapse could operate.

**Purpose:** The aim is not to introduce new required mechanisms but to situate the collapse within a plausible Earth-system response involving hydrology, atmospheric dynamics, and potential triggering events.
...
## **C.1. Potential Triggering Environments**
...
## **C.2. Hydrological Dynamics Under Global Inundation**
...
```
Q_evap = A_ocean × E × ρ × L_v
```

Using E = 15 mm/day = 1.74 × 10⁻⁷ m/s:

```
Q_evap ≈ (5 × 10¹⁴ m²) × (1.74 × 10⁻⁷ m/s) × (10³ kg/m³) × (2.5 × 10⁶ J/kg)
Q_evap ≈ 2.2 × 10¹⁷ W
```
...
### **C.2.2. Atmospheric Radiative Export**
...
```
ΔQ_rad ≈ 4 × Q_rad × (ΔT/T) ≈ 4 × 240 × 0.1 ≈ 96 W/m² additional export
```
...
## **C.3. Hypercane-Class Storms as Potential Heat Transporters**

Theoretical work on hypercanes suggests that extremely warm ocean surfaces can generate storms with very high latent heat fluxes. In a globally inundated environment with anomalously warm surface temperatures, such storms could form more readily and may represent a significant atmospheric heat-removal pathway.

### **C.3.1. Formation Conditions**

Under conditions where localized ocean regions reach 305-315 K (32-42°C) due to proximity to active collapse zones, atmospheric instability would drive formation of intense tropical cyclone analogs. While full hypercane conditions (requiring >323 K or 50°C) may not be reached, exceptionally intense hurricanes operating continuously across warm water regions become plausible.

### **C.3.2. Heat Transport Capacity**

**Order-of-magnitude estimate:**

A modern Category 5 hurricane dissipates ~6 × 10¹⁴ W at peak intensity. Enhanced storm systems operating continuously over warm water could sustain higher dissipation rates. If multiple such systems operate simultaneously across different ocean basins, total atmospheric heat transport could reach:

```
Q_storm ~ 10¹⁵ - 10¹⁶ W
```

**Mechanism:** Storm updrafts transport latent heat from surface to altitude (10-15 km), where:
- Condensation releases heat into upper troposphere
- Radiative cooling to space becomes highly efficient
- Heat is exported rather than accumulating at surface

**Critical distinction:** Storm systems act as convective heat pumps, moving energy from the region where it threatens the biosphere (surface) to regions where it can be radiated to space (high altitude). This redistributes heat already introduced into the system rather than generating additional heat.

### **C.3.3. Uncertainties**

A complete quantitative assessment would require:
- Ocean surface temperature evolution modeling
- Latent heat flux models for hypercane-strength systems
- Radiative transfer modeling for high-altitude condensation
- Storm lifetime and frequency predictions
- Coupled ocean-atmosphere simulations

These calculations are beyond the scope of this appendix but represent important directions for strengthening the atmospheric heat export component of the model.

---

## **C.4. Integration with Primary Heat Budget**
...
**Important caveat:** These atmospheric calculations are order-of-magnitude estimates with significant uncertainties (see Section C.8). They demonstrate plausibility and provide bounds rather than precise predictions. The core heat solution remains the shallow water-mediated friction collapse presented in the main paper.

---

## **C.5. Interaction Between Surface Hydrology and Crustal Failure**
...
## **C.6. Observational Versus Global-Scale Perspective**
...
Longmire, J.D. (2025). Rapid Continental Reorganization Through Hydraulic Collapse: A Solution to the Heat Problem in Catastrophic Plate Tectonics. *Zenodo*. https://doi.org/10.5281/zenodo.17663309
...
**Affiliation:** Northrop Grumman Fellow (unaffiliated research)
**License:** CC BY 4.0
**DOI:** 10.5281/zenodo.17663309 (main paper)

**Suggested citation:**
Longmire, J.D. (2025). Appendix C: Earth-System Context for Hydraulic Collapse. Supplementary Material for "Rapid Continental Reorganization Through Hydraulic Collapse". *Zenodo*. https://doi.org/10.5281/zenodo.17663309
